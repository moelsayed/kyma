...
func main() {
	...
	fnRecon := serverless.NewFunction(resourceClient, zapLogger, config.Function, git.NewGit2Go(), mgr.GetEventRecorderFor(serverlessv1alpha2.FunctionControllerValue), prometheusCollector, healthCh)
